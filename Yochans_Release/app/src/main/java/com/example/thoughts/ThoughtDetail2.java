...
public class ThoughtDetail2 extends AppCompatActivity {
    ...
    CircleImageView BackgroundImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View header = (View) getLayoutInflater().inflate(R.layout.thought_large2, null);
        CommentListView.addHeaderView(header);

        BackgroundImageView = (CircleImageView) findViewById(R.id.backgroundImageView);
        ...
        int resID = getApplicationContext().getResources().getIdentifier(Background.concat("_ss"), "drawable", getApplicationContext().getPackageName());
        BackgroundImageView.setImageResource(resID);
        BackgroundTextView.setText(Background.toUpperCase());
        ...
        if(intent.getStringExtra("Anonymous").equals("false")){
            ...
            if(intent.getStringExtra("User").length() < 20) {
                UserTextView.setText("by : " + intent.getStringExtra("User"));
            }else{
                UserTextView.setText("by : " + intent.getStringExtra("User").substring(0,20) + "...");
            }
    ...
    private class AsyncAdapter extends AsyncTask<Void,Void,ListViewAdapter>{
        ...
        protected ListViewAdapter doInBackground(Void... voids) {
            ...
            adapter = new ListViewAdapter(ThoughtDetail2.this, Comments, Verify, CommentId, intent.getStringExtra("User"),intent.getStringExtra("ThoughtId"), SymbolComment, ReplyCount);
            return adapter;
        }
